// data/widgetDefaults.ts
import { WidgetTypes } from '@/types';

// Widget size configurations
export const widgetSizes: Record<string, { w: number; h: number }> = {
    [WidgetTypes.ONE_METRIC]: { w: 2, h: 1.5 },
    [WidgetTypes.ONE_METRIC_DATE]: { w: 2, h: 1.5 },
    [WidgetTypes.TWO_METRICS_LINECHART]: { w: 4, h: 3 },
    [WidgetTypes.TWO_METRICS]: { w: 2.5, h: 1.5 },
    [WidgetTypes.TWO_METRICS_PIECHART]: { w: 2.5, h: 1.5 },
    [WidgetTypes.ONE_METRIC_TABLE]: { w: 3, h: 3 },
    [WidgetTypes.BAR_CHART]: { w: 2.5, h: 3 },
    [WidgetTypes.STACKED_BAR_CHART]: { w: 6, h: 3 },
    [WidgetTypes.ORDERS_LINE_CHART]: { w: 4, h: 3 },
    [WidgetTypes.DUAL_LINE_CHART]: { w: 4, h: 3 },
    [WidgetTypes.PIE_CHART_TOTAL]: { w: 2.5, h: 3 },
    [WidgetTypes.QUADRANT_METRICS]: { w: 4, h: 3 },
    [WidgetTypes.LOANS_APP_TRAY]: { w: 6, h: 3 }
};
