...
const SingleLineChart = ({data}: ChartProps) => {
        ...
        <div className="w-full h-full " >
          <div className="h-full bg-gradient-to-b from-[#00214E] to-[#0164B0] p-4 rounded-xl text-white">
            <div className="flex justify-between">
              ...
              <p className="text-green-400 font-bold">{data?.metric_data?.metric_value}<span className="text-sm">{data?.metric_data?.metric_variance}</span></p>
            </div>
    ...
    >
      {/* <ResponsiveContainer width="100%" height="100%"> */}
        ...
        >
          <YAxis orientation="right" tick={{ fill: "white" }} tickLine={false} axisLine={false} />
          <XAxis dataKey="date" tick={{ fill: "white" }} tickLine={false} axisLine={true} tickMargin={8} />
